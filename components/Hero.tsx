      ...
      return (
        <div className="min-h-screen justify-center">
            <div className="text-center text-white">
                <h1 className="text-md pt-[50px] font-sans">You're Invited to</h1>
                <h1 className="text-2xl mb-2 font-edensor">The Wedding of</h1>
                <h2 className="text-5xl mb-4 font-belgiano-serif font-[2px]">Yoga <span className='font-abigail'>&</span> Irma</h2>
                <p className="text-md mb-4 font-edensor">Monday, 10 September 2024</p>

                <p className="text-xl mb-2 pt-[180px] italic font-edensor">Dear,</p>
