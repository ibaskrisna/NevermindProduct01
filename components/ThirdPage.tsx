            ...
            <div className="m-10 relative z-10 w-screen">
                <div className="row">
                    <div className="col-md-8">
                        <div className="mt-10">
                            <h1 className='text-white text-[28px] leading-[28px] font-edensor'>The Journey of</h1>
                            <h1 className='text-white text-[28px] leading-[28px] font-edensor'>Two Souls</h1>
                            <h1 className='text-white text-[28px] leading-[28px] font-edensor'>in Love</h1>
                            <hr className='my-3' />
